...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">ESTJ</h1> <div class="detail-img-box">
                <img src="images/estj.jpg" alt="ESTJ"> </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="isfj.php" class="nav-button">← 上一個 (ISFJ)</a>
        <a href="esfj.php" class="nav-button">下一個 (ESFJ) →</a>
    </div>
</main>
