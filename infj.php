...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">INFJ</h1> <div class="detail-img-box">
                <img src="images/infj.jpg" alt="INFJ"> </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="entp.php" class="nav-button">← 上一個 (ENTP)</a>
        <a href="infp.php" class="nav-button">下一個 (INFP) →</a>
    </div>
</main>
