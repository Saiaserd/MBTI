...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">ENFJ</h1> <div class="detail-img-box">
                <img src="images/enfj.jpg" alt="ENFJ"> </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="infp.php" class="nav-button">← 上一個 (INFP)</a>
        <a href="enfp.php" class="nav-button">下一個 (ENFP) →</a>
    </div>
</main>
