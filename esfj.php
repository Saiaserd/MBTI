...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">ESFJ</h1> <div class="detail-img-box">
                <img src="images/esfj.jpg" alt="ESFJ"> </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="estj.php" class="nav-button">← 上一個 (ESTJ)</a>
        <a href="istp.php" class="nav-button">下一個 (ISTP) →</a>
    </div>
</main>
