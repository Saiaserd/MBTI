...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">INTP</h1> <div class="detail-img-box">
                <img src="images/intp.jpg" alt="INTP"> </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="intj.php" class="nav-button">← 上一個 (INTJ)</a>
        <a href="entj.php" class="nav-button">下一個 (ENTJ) →</a>
    </div>
</main>
