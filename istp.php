...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">ISTP</h1> <div class="detail-img-box">
                <img src="images/istp.jpg" alt="ISTP"> </div>
        </div>
        ...
        <div class="detail-right-section">
            ...
            <div class="description-box">
                <h3>人格介紹</h3>
                <p>
                    社會哥，人狠話不多，情商低，不理人，厭蠢症，看誰不順眼就開罵，感情上遲鈍，聽不懂任何潛台詞。
                </p>
            </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="esfj.php" class="nav-button">← 上一個 (ESFJ)</a>
        <a href="isfp.php" class="nav-button">下一個 (ISFP) →</a>
    </div>
</main>
