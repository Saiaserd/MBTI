...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">ISTJ</h1> <div class="detail-img-box">
                <img src="images/istj.jpg" alt="ISTJ"> </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="enfp.php" class="nav-button">← 上一個 (ENFP)</a>
        <a href="isfj.php" class="nav-button">下一個 (ISFJ) →</a>
    </div>
</main>
