...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">ESTP</h1> <div class="detail-img-box">
                <img src="images/estp.jpg" alt="ESTP"> </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="isfp.php" class="nav-button">← 上一個 (ISFP)</a>
        <a href="esfp.php" class="nav-button">下一個 (ESFP) →</a>
    </div>
</main>
