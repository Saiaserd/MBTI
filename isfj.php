...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">ISFJ</h1> <div class="detail-img-box">
                <img src="images/isfj.jpg" alt="ISFJ"> </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="istj.php" class="nav-button">← 上一個 (ISTJ)</a>
        <a href="estj.php" class="nav-button">下一個 (ESTJ) →</a>
    </div>
</main>
