...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const introData = {
        ...
        "Ni": " Ni在1位（INTJ/INFJ）：主導核心，深度洞察、長期預見，思維收斂聚焦，行動圍繞核心願景，具深遠性。
                Ni在2位（ENTJ/ENFJ）：輔助執行，將洞見落地，平衡理想與現實，善於用遠景驅動團隊。
                Ni在3位（ISTP/ISFP）：少年功能，偶有深刻直覺，用於豐富體驗或輔助決策，壓力下易悲觀。
                Ni在4位（ESTP/ESFP）：劣勢功能，排斥抽象預測，壓力下易災難化想像、偏執。
                Ni在5位（ENFP/ENTP）：陰影功能，壓力下內在質疑不夠深刻，易引發自我內耗。
                Ni在6位（INFP/INTP）：批判功能，壓力下提供隱憂預感，易反思過度。
                Ni在7位（ESFJ/ESTJ）：愚者功能，易被誤導、偏執，忽視現實細節，判斷脫離實際。
                Ni在8位（ISFJ/ISTJ）：魔鬼功能，難以觸及，易固執經驗、抗拒變化與長期預測。",
