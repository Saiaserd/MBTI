...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">ENFP</h1> <div class="detail-img-box">
                <img src="images/enfp.jpg" alt="ENFP"> </div>
        </div>
        ...
        <div class="detail-right-section">
            ...
            <div class="description-box">
                <h3>人格介紹</h3>
                <p>
                    以自我為中心，容易下頭變心，快樂小狗，渴望被偏愛，三分鐘熱度，三分鐘熱度，缺乏實踐和務實精神，完全安靜不下來。
                </p>
            </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="enfj.php" class="nav-button">← 上一個 (ENFJ)</a>
        <a href="istj.php" class="nav-button">下一個 (ISTJ) →</a>
    </div>
</main>
