...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">ESFP</h1> <div class="detail-img-box">
                <img src="images/esfp.jpg" alt="ESFP"> </div>
        </div>
        ...
        <div class="detail-right-section">
            ...
            <div class="description-box">
                <h3>人格介紹</h3>
                <p>
                    浮誇，愛慕虛榮，表演型人格，社交恐怖分子，娛樂至上，不顧後果。
                </p>
            </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="estp.php" class="nav-button">← 上一個 (ESTP)</a>
        <a href="intj.php" class="nav-button">下一個 (INTJ) →</a>
    </div>
</main>
