...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">ENTP</h1> <div class="detail-img-box">
                <img src="images/entp.jpg" alt="ENTP"> </div>
        </div>
        ...
        <div class="detail-right-section">
            ...
            <div class="description-box">
                <h3>人格介紹</h3>
                <p>
                    杠精，什麼事都喜歡辯論，臉皮厚，愛冒犯人，喜歡捉弄別人，愛開地獄玩笑，沒邊界感。
                </p>
            </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="entj.php" class="nav-button">← 上一個 (ENTJ)</a>
        <a href="infj.php" class="nav-button">下一個 (INFJ) →</a>
    </div>
</main>
