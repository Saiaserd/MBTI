...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">ISFP</h1> <div class="detail-img-box">
                <img src="images/isfp.jpg" alt="ISFP"> </div>
        </div>
        ...
        <div class="detail-right-section">
            ...
            <div class="description-box">
                <h3>人格介紹</h3>
                <p>
                    文藝青年，幼稚又愛幻想，只顧自己，擺爛，拖延症，不接受批評，對任何事情都不在乎，一定會畫畫。
                </p>
            </div>
        </div>
    ...
    <div class="nav-buttons-container">
        <a href="istp.php" class="nav-button">← 上一個 (ISTP)</a>
        <a href="estp.php" class="nav-button">下一個 (ESTP) →</a>
    </div>
</main>
