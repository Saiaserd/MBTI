...
<body>
    ...
    <div class="mbti-detail-container">
        ...
        <div class="detail-left-section">
            <h1 class="mbti-title">INTJ</h1> <div class="detail-img-box">
                <img src="images/intj.jpg" alt="INTJ"> </div>
        </div>
        ...
        <div class="detail-right-section">
            ...
            <div class="description-box">
                <h3>人格介紹</h3>
                <p>
                    卷王，偏執狂，執行力極高，為達目的不擇手段，PLAN-A/B/C，有嚴重的秩序敏感，面具人2號。
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="nav-buttons-container">
        <a href="esfp.php" class="nav-button">← 上一個 (ESFP)</a>
        <a href="intp.php" class="nav-button">下一個 (INTP) →</a>
    </div>
</main>
